...
> **Compatibility:** tested against the **[BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) v6 skill line** up to **6.8.0** (and the **6.8.1-next.10** prerelease), and the separately versioned **[TEA test-architecture module](https://github.com/bmad-code-org/bmad-method-test-architecture-enterprise) v1 line** (the `testarch` skills) up to **1.19.0** — auto-bmad couples to those skills' contracts rather than pinned versions.
